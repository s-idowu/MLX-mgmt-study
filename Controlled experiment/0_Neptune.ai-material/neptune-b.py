# Experiment with Neptune.ai Group B
...
# Feature Selection
#df = df[['Population', 'AveOccup', 'Latitude', 'Longitude']] # Feature 1
#df = df[['MedInc', 'HouseAge', 'AveBedrms']] # Feature 2
# Here we are downloading the DataFrame as .csv file
dataset = df.to_csv("data.csv", index=None)

# Between the quotes write a path where you want to save the data.csv. e.g 'data/dataset'
...
## Log the parameters_rfr and split_param below:
